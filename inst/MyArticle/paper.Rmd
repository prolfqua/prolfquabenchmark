...
```{r proDAAllBenchmarks, fig.cap="Comparison of fold change estimates produced by proDA and prolfqua simple impute method."}
...
ggplot2::ggplot(x,ggplot2::aes( x = diff.imp, y = diff.proda) ) + ggplot2::geom_point() + ggplot2::facet_wrap(~contrast + species) + ggplot2::geom_hline(yintercept = 0, color="lightgray") + ggplot2::geom_vline(xintercept = 0, color="lightgray") + ggplot2::geom_abline(slope = 1) + ggplot2::theme_minimal()
