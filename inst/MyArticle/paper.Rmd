...
In summary, `r BiocStyle::Githubpkg("fgcz/prolfqua")` is an easy-to-use and feature-rich R package to analyze quantitative mass spectrometric data with simple and complex experimental designs. It also can generate conclusive reports, and benchmark MS software and statistical methods. Furthermore, with very little adaptations this R package can also be adapted to analyze different quantitative proteomics data (e.g. labeling based TMT-, PRM- DIA-data or even other omics scale datasets such as microarray data).
