...
```{r contrast2, eval = FALSE, echo = TRUE}
# NOTE: data_Yeast2Factor was removed from prolfqua; showing code only
...
# NOTE: tidy_FragPipe_combined_protein_deprec and AnalysisTableAnnotation
# were removed from prolfqua; showing code only
datadir <- file.path(find.package("prolfquadata") , "quantdata")
...
```{r proLFQuaSticker, echo=TRUE, out.width="3cm", eval=TRUE, fig.cap="Sticker maintainer: Witold E. Wolski; License: Creative Commons Attribution CC-BY. Feel free to share and adapt, but don't forget to credit the author."}
...
```{r toc, echo=FALSE, fig.cap="(ref:toc)", out.width="\\textwidth"}
knitr::include_graphics("graphics/prolfqua-toc.png")
