...
knitr::include_graphics("graphics/LFQData_UML_V2.png")
```
...
knitr::include_graphics("graphics/ContrastClassesUML.png")
```
...
conI <- prolfqua::ContrastsMissing$new( lfqp, contrasts) |> 
  prolfqua::ContrastsModerated$new()
...
```{r}
allBenchmarks <- readRDS(file.path("../../inst/Benchresults/",format( Sys.Date(), "%Y%m%d"),"allBenchmarks.RDS"))
benchmark_msstats <- readRDS(file.path("../../inst/Benchresults/",format( Sys.Date(), "%Y%m%d"),"benchmark_msstats.RDS"))
msFragger <- readRDS(file = file.path("../../inst/Benchresults/",format( Sys.Date(), "%Y%m%d"),"MSFragger_medpol_benchmark.RDS"))
