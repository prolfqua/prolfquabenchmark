...
ttd <- ionstar_bench_preprocess(contrProt_RLM$get_contrasts())


benchmark_Prot_RLM <- make_benchmark(
    ttd$data,
...
ttd <- ionstar_bench_preprocess(contrProtRLMModerated$get_contrasts())
benchmark_ProtRLMModerated <- make_benchmark(
    ttd$data,
