...
if (!evalAll) {
  missing <- c("QFeatures", "msqrob2", "limma")[
    !vapply(c("QFeatures", "msqrob2", "limma"), requireNamespace,
            logical(1), quietly = TRUE)]
  cat("> **Note:** This vignette requires packages not currently installed:",
      paste0("`", missing, "`", collapse = ", "),
      ". All code chunks are skipped. Install them and re-render to see results.\n")
}
```
