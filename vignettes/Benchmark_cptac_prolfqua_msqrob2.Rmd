---
title: "DEA benchmark CPTAC/MaxQuant/peptide.txt (prolfqua, msqrob2)"
...
geometry: margin=.5in
vignette: >
  %\VignetteIndexEntry{DEA benchmark CPTAC/MaxQuant/peptide.txt (prolfqua, msqrob2)}
...
```{r fig.cap="Comparing msqrob2 and prolfqua using the pAUC_{10}", eval = evalAll}
...
all <- dplyr::bind_rows(list(mrob, prolfqua))
...
```{r roctest, include = TRUE, message=FALSE, error=FALSE, eval = evalAll}
...
```{r shwoROCtestREsults, eval = evalAll}
