...
ttd <- prolfqua::ionstar_bench_preprocess(contrProtDEqMS$get_contrasts())
benchmark_ProtDEqMS <- prolfqua::make_benchmark(
    ttd$data,
...
ttd <- prolfqua::ionstar_bench_preprocess(contrLimma$get_contrasts())
benchmark_Limma <- prolfqua::make_benchmark(
    ttd$data,
...
ttd <- prolfqua::ionstar_bench_preprocess(merged_deqms$get_contrasts())
benchmark_merged_deqms <- prolfqua::make_benchmark(
    ttd$data,
...
ttd <- prolfqua::ionstar_bench_preprocess(merged_limma$get_contrasts())
benchmark_merged_limma <- prolfqua::make_benchmark(
    ttd$data,
