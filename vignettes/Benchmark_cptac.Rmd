...
In this experiment, the Sigma Universal Protein Standard mixture 1 (UPS1) containing 48 different human proteins was spiked in a protein background of 60 ng/$\muL$ Saccharomyces cerevisiae strain BY4741. Two different spike-in concentrations were used, 6A ($0.25$ fmol UPS1 proteins/$\mu L$) and 6B ($0.74$ fmol UPS1 proteins/$\mu L$). Three replicates are available for each concentration.
...
tmp <- c(msqrob_vs_prolfqua = pROC::roc.test(ddmsqrob,ddprolfqua, progress = "none")$p.value,
         msqrob_vs_proda = pROC::roc.test(ddmsqrob,ddproda, progress = "none")$p.value,
