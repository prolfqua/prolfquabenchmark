---
title: "Benchmarking MSstats DEA using the Ionstar Dataset/MaxQuant"
...
saveRDS(benchmark2_msstats, file = file.path("../inst/Benchresults/",format( Sys.Date(), "%Y%m%d"),"benchmark_msstats.RDS"))
```
...
```{r plotPrecisionRecall, fig.cap="Precision recall curve.", eval = evalAll}
